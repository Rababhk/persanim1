(function ($) {
    ...
    var ajaxurl = coolte_admin.ajax_url;
    var coolteNonce = coolte_admin.ajax_nonce;
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: coolte_admin.upload_image,
            button: {
            text: coolte_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'coolte_notice_dismiss',
            '_wpnonce': coolteNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-coolte-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-coolte-notice').addClass('twp-installing');

        var data = {
            'action': 'coolte_install_plugins',
            '_wpnonce': coolteNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = coolte_admin.active
            var deactivate = coolte_admin.deactivate
